    ...
    return (
        <form onSubmit={handleSubmit} className='flex flex-col'>
            ...
            <div className='mt-6 px-2 flex flex-row justify-start items-center w-full h-5'>
                ...
                <label htmlFor="agree_privacy_policy" className='ml-2'>{trans.register.privacy_policy}</label>
            </div>
            <div className='mt-2 w-full h-40 p-2 bg-gray-100 overflow-auto border-[1px] border-gray-400 rounded-sm'>
            ...
            <div className='mt-6 px-2 flex flex-row justify-start items-center w-full h-5'>
                ...
                <label htmlFor="agree_event_promotion_policy" className='ml-2'>{trans.register.event_promotion_policy}</label>
            </div>
            <div className='mt-2 w-full h-40 p-2 bg-gray-100 overflow-auto border-[1px] border-gray-400 rounded-sm'>
